...
The stages of the `connect()` sequence, used to tag a [ProtectBootstrapError](../classes/ProtectBootstrapError.md). The sequence authenticates, fetches the bootstrap document, parses it,
