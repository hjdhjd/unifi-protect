...
controller always addresses on channel 0); the two can never be combined. Tag-discriminated (matching [Segment](Segment.md)) so the discriminant is authoritative regardless
