...
[Home](../README.md) / ProtectFobConfigInterface

# Interface: ProtectFobConfigInterface
...
(inherited from [ProtectDeviceBaseInterface](ProtectDeviceBaseInterface.md)) plus its away/arm state, its button-label profile, any pending arm action, and its LoRa link state. It reports
...
| <a id="awaystate"></a> `awayState` | `string` | - |
| <a id="buttonlabels"></a> `buttonLabels` | `string` | - |
...
| <a id="pendingactionexpiresat"></a> `pendingActionExpiresAt` | `Nullable`\<`number`\> | - |
| <a id="pendingactiontype"></a> `pendingActionType` | `Nullable`\<`string`\> | - |
