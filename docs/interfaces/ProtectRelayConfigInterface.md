...
[Home](../README.md) / ProtectRelayConfigInterface

# Interface: ProtectRelayConfigInterface
...
[ProtectDeviceBaseInterface](ProtectDeviceBaseInterface.md)) plus its per-output state, LoRa link state, and radio settings. It reports `host: null` and omits `isConnected`, which is why the
...
| <a id="connectiontype"></a> `connectionType` | `Nullable`\<`string`\> | - |
...
| <a id="host"></a> `host` | `Nullable`\<`string`\> | [`ProtectDeviceBaseInterface`](ProtectDeviceBaseInterface.md).[`host`](ProtectDeviceBaseInterface.md#host) |
| <a id="id"></a> `id` | `string` | [`ProtectDeviceBaseInterface`](ProtectDeviceBaseInterface.md).[`id`](ProtectDeviceBaseInterface.md#id) |
| <a id="inputs"></a> `inputs` | [`ProtectRelayInputConfigInterface`](ProtectRelayInputConfigInterface.md)[] | - |
...
| <a id="modelkey"></a> `modelKey` | `"relay"` | - |
...
| <a id="outputs"></a> `outputs` | [`ProtectRelayOutputConfigInterface`](ProtectRelayOutputConfigInterface.md)[] | - |
