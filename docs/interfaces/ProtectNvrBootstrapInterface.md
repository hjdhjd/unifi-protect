[unifi-protect](../README.md) / [Exports](../modules.md) / ProtectNvrBootstrapInterface

# Interface: ProtectNvrBootstrapInterface

## Indexable

▪ [key: `string`]: [`ProtectCameraConfig`](ProtectCameraConfig.md)[] \| [`ProtectChimeConfig`](ProtectChimeConfig.md)[] \| [`ProtectLightConfig`](ProtectLightConfig.md)[] \| [`ProtectNvrConfig`](ProtectNvrConfig.md) \| [`ProtectNvrLiveviewConfig`](ProtectNvrLiveviewConfig.md)[] \| [`ProtectNvrUserConfig`](ProtectNvrUserConfig.md)[] \| [`ProtectSensorConfig`](ProtectSensorConfig.md)[] \| [`ProtectViewerConfig`](ProtectViewerConfig.md)[] \| `string` \| `unknown`[]
