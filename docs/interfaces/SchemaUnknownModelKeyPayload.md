...
Payload published on [channels.schemaUnknownModelKey](../variables/channels.md#property-schemaunknownmodelkey). `action` and `exampleId` are the discriminating fields from the offending packet's header so a consumer
